...
set _DeploySetParametersFile=%RootPath%WebServiceForAdvertisingPlatforms.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%WebServiceForAdvertisingPlatforms.zip" (
echo "%RootPath%WebServiceForAdvertisingPlatforms.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%WebServiceForAdvertisingPlatforms.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%WebServiceForAdvertisingPlatforms.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%WebServiceForAdvertisingPlatforms.deploy-readme.txt" (
...
start notepad "%RootPath%WebServiceForAdvertisingPlatforms.deploy-readme.txt"
)
echo =========================================================
goto :eof
